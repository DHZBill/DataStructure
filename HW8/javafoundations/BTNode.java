...
{
  protected T element;
  protected BTNode<T> left, right, parent;
  ...
  public BTNode<T> findParent (T target)
  {
    BTNode<T> result = null;
    
    if (left!=null && left.getElement().equals(target))
      result = this;
    if(right!=null && right.getElement().equals(target))
      result = this;      
    else
    {
      if (left.getLeft() != null)
        result = left.getLeft().find(target);
      if (left.getRight() != null)
        result = left.getRight().find(target);
      if (result == null && right.getLeft() != null)
        result = right.getLeft().find(target);
      if (result == null && right.getRight() != null)
        result = right.getRight().find(target);
    }
